...
.PHONY: build test run fmt dev docker-build docker-run setup-local-voice perf-latency perf-latency-local perf-replay
...
perf-latency-local:
	./scripts/perf_latency_local_baseline.sh

perf-replay:
	./scripts/perf_voice_replay.sh
